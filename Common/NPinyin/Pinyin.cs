...
namespace Common.NPinyin
{
    /// <summary>
    /// 本项目开源地址：https://code.google.com/archive/p/npinyin/source/default/source
    /// </summary>
    public static class Pinyin
    {
        ...
        public static string GetPinyinTrme(string text)
        {
            return GetPinyin(text).Replace(" ", "");
        }
